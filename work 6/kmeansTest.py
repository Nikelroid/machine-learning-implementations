...
def kmeans_classification():
    ...
    print('[*] Accuracy of logistic regression classifier is {}'.format(np.mean(y_hat_test == y_test)))

    KNNClassifier = KNeighborsClassifier()
    KNNClassifier.fit(x_train, y_train)
    y_hat_test = KNNClassifier.predict(x_test)
    print('[*] Accuracy of Nearest Neighbour classifier is {}'.format(np.mean(y_hat_test == y_test)))
